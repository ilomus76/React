...
function Pagination(props){
    ...
    const {totalCount, pageSize, currentPage, setCurrentPage} = props
        ...
        <div className="page-button-container">          
            {
                ...
                numbers.map((num,idx)=><button key={idx} className="page-button" aaa={num==pageSize? 'aaa':null} onClick={()=>setCurrentPage(num)}>{num}</button>)
            }
